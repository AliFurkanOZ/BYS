    ...
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> PersonalLessons()
        {
            try
            {
                ...
                var response = await _httpClient.GetAsync($"https://localhost:7186/api/studentcourseselections/{x}");
        ...
        {
            var response = await _httpClient.GetAsync($"https://localhost:7186/api/CourseSelectionHistories/{studentID}");
        ...
        {
            var response = await _httpClient.GetAsync("https://localhost:7186/api/courses");
        ...
        {
            int a;
            string courseQuotaApiUrl = "https://localhost:7186/api/coursequotas/";
            ...
            foreach (var courseId in selectedCourseIds)
            {
                ...
                var response = await _httpClient.PostAsJsonAsync("https://localhost:7186/api/nonconfirmedselections", nonConfirmedSelection);
            ...
            foreach (var courseId in selectedCourseIds)
            {
                ...
                string courseSelectionHistoryApiUrl = $"https://localhost:7186/api/CourseSelectionHistories";
